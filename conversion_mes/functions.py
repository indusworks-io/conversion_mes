...
def site_automation():
    try:
        ...
        frappe.log_error(f"Error in site_automation: {e}")
...
def is_working_day_checker(today_day, site):
    try:
        ...
        frappe.log_error(f"Error in is_working_day_checker: {e}")
...
def is_holiday_checker(today_date, site):
    try:
        ...
        frappe.log_error(f"Error in is_holiday_checker: {e}")
...
def create_holiday_dt(today_date, site, holiday_description):
    try:
        ...
        frappe.log_error(f"Error in create_holiday_dt: {e}")
...
def create_no_shifts_dt(today_date, site):
    try:
        ...
        frappe.log_error(f"Error in create_no_shifts_dt: {e}")
...
def create_non_working_day_dt(today_date, site):
    try:
        ...
        frappe.log_error(f"Error in create_non_working_day_dt: {e}")
...
def create_breaks_dt(site, today_date):
    try:
        ...
        frappe.log_error(f"Error in create_breaks_dt: {e}")
...
def create_shift_logs(site, today_date):
    try:
        ...
        frappe.log_error(f"Error in create_shift_logs: {e}")